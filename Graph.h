...
public:
    ...
    /* Use normal Dijkstra with an addition path array to keep track of number of paths
       Increment by or reset to the number of paths of predcessor as necessary */
...
private:
    ...
    vector<set<pair<int, int>>> edgemap; //adjacency list
};
